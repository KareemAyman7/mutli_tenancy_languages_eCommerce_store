                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">  {{__('admin\brands.edit_brand')}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title" id="basic-layout-form"> {{__('admin\brands.edit_brand')}} </h4>
                                        ...
                                        <form class="form"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label id="projectinput7" class="file center-block">
                                                    <input type="file" id="file" name="photo" onchange="document.getElementById('displayphoto').src = window.URL.createObjectURL(this.files[0])">
