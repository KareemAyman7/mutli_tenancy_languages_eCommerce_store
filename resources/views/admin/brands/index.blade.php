                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table id="example_table"
                                            ...
                                            <thead class="">
                                            <tr>
                                                <th>{{__('admin\brands.table_name')}} </th>
                                                <th>{{__('admin\brands.table_status')}}</th>
                                                <th>{{__('admin\brands.table_photo')}}</th>
                                                <th>{{__('admin\brands.table_action')}}</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            @isset($brands)
                                                @foreach($brands as $brand)
                                                    <tr style="font-weight: 700;">
                                                        ...
                                                        <td> <img style="width: 100px; height: 100px;" src="{{$brand -> photo}}"></td>
                                                        <td>
