            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.maincategories')}}"
                                          data-i18n="nav.dash.ecommerce"> {{__('admin\sidebar.show_all_cats')}} </a>
                    </li>
                    <!--<li><a class="menu-item" href="{{route('admin.subcategories')}}"
                     data-i18n="nav.dash.ecommerce"> {{__('admin\sidebar.show_all_subcats')}} </a>
                     </li>-->
                    <li><a class="menu-item" href="{{route('admin.maincategories.create')}}" data-i18n="nav.dash.crypto">
                     {{__('admin\sidebar.add_new_cat')}} </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                ...
                <ul class="menu-content">
                    <li class="active"><a class="menu-item" href="{{route('admin.brands')}}"
                                          data-i18n="nav.dash.ecommerce"> {{__('admin\sidebar.allbrands')}} </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.brands.create')}}" data-i18n="nav.dash.crypto">  {{__('admin\sidebar.add_brand')}} </a>
                    </li>
                </ul>
            </li>
              ...
              <li class="nav-item">
                     ...
                     <ul class="menu-content">
                            <li class="active">
                                   <a class="menu-item" href="{{route('admin.tags')}}" data-i18n="nav.dash.ecommerce"> {{__('admin\sidebar.alltags')}} </a>
                            </li>
                            <li>
                                   <a class="menu-item" href="{{route('admin.tags.create')}}" data-i18n="nav.dash.crypto">  {{__('admin\sidebar.add_tag')}} </a>
                            </li>
                     </ul>
              </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">{{__('admin\sidebar.shipping methods')}}</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.edit.shipping', 'free')}}"
                                   data-i18n="nav.templates.vert.classic_menu">{{__('admin\sidebar.free')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.edit.shipping', 'inner')}}">{{__('admin\sidebar.inner')}}</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.edit.shipping', 'outer')}}"
